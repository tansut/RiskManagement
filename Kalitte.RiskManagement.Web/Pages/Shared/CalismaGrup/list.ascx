<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="list.ascx.cs" Inherits="Kalitte.RiskManagement.Web.Pages.Shared.CalismaGrup.list" %>
        ...
        <tt:TTGrid ID="grid" runat="server" StoreID="dsMain">
                    ...
                    <Items>
                        <tt:TTButtonGroup ID="ButtonGroup1" runat="server" Title="Genel İşlemler">
                            <Items>
                                ...
                                <tt:TTCmdButon ID="ctlCreateBtn" runat="server" KnownCommand="DeleteEntity" Permission="Puanlama Grubu Silme" />
                            </Items>
                        </tt:TTButtonGroup>
                    </Items>
                </ext:Toolbar>
            ...
            <ColumnModel ID="ColumnModel1" runat="server">
                <Columns>
                    ...
                    <tt:TTColumn DataIndex="GrupTur" Header="Tür" Width="50">
                    </tt:TTColumn>
