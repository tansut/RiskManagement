...
namespace Kalitte.RiskManagement.Web.Pages.Management.City
{
    public partial class edit : EditorViewControl<CityBusiness>
    {
        ...
        public void UpdateEntityHandler(object sender, CommandInfo command)
        {
            ...
            entity.Kod = ctlCode.ValueAsInt;
            entity.Ad = ctlCityName.Text;
        ...
        public void EditInEditorHandler(object sender, CommandInfo command)
        {
            ...
            CurrentID = entity.ID;
            ctlCode.ValueAsInt = entity.Kod;
            ctlCityName.Text = entity.Ad;
            entityWindow.Show();
        }
