...
namespace Kalitte.RiskManagement.Web.UI.Pages.Management.SurecDayanakTanim
{

    public partial class edit : EditorViewControl<SurecDayanakTanimBusiness>
    {
        ...
        {
            var entity = new Kalitte.RiskManagement.Framework.Model.SurecDayanakTanim();
            entity.Ad = ctlAd.Text;
            entity.Aciklama = ctlAciklama.Text;
