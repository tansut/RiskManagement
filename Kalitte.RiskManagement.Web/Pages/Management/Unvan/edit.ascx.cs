...
namespace Kalitte.RiskManagement.Web.UI.Pages.Management.Unvan
{

    public partial class edit : EditorViewControl<UnvanBusiness>
    {
        ...
        {
            entityWindow.Title = "Unvan Tanımla";
        ...
        {
            var entity = new Kalitte.RiskManagement.Framework.Model.Unvan();
            entity.Ad = ctlAd.Text;
