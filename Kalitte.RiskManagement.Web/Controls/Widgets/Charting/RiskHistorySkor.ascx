<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RiskHistorySkor.ascx.cs" Inherits="Kalitte.RiskManagement.Web.Controls.Widgets.Charting.RiskHistorySkor" %>
