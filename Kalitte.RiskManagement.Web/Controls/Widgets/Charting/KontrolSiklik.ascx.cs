...
{
    public partial class KontrolSiklik : BaseChart
    {
        ...
        protected override void DataBindChart(WidgetInstance instance)
        {
            ...
            var data = new ControlReportBusiness().RetreiveKontrolParameter("Siklik", listingParams);
            ThisChart.Series.Clear();
            databindchart("Kontrol Sıklık", data);
        }
