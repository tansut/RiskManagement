<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RiskDurum.ascx.cs" Inherits="Kalitte.RiskManagement.Web.Controls.Widgets.Charting.RiskDurum" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false">
    <ContentTemplate>
        <asp:Label ID="ctlDesc" runat="server" CssClass="widget-description"></asp:Label>
        <asp:Chart ID="chr" runat="server" OnClick="chr_Click">
            <Titles>
