<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RiskHistoryRisk.ascx.cs"
    Inherits="Kalitte.RiskManagement.Web.Controls.Widgets.Charting.RiskHistoryRisk" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <asp:Label ID="ctlDesc" runat="server" CssClass="widget-description"></asp:Label>
        <asp:Chart ID="chr" runat="server">
            <Titles>
                <asp:Title Name="chartTitle" DockedToChartArea="ChartArea1" IsDockedInsideChartArea="false"
                    ForeColor="26, 59, 105" Font="Trebuchet MS, 11.25pt, style=Bold" ShadowOffset="0" />
            </Titles>
            <Legends>
            ...
            <ChartAreas>
                <asp:ChartArea Name="ChartArea1" BackColor="64, 165, 191, 228" ShadowColor="Transparent"
                    ...
                    <AxisX LineColor="64, 64, 64, 64" LabelAutoFitStyle="WordWrap">
                        <LabelStyle Font="Trebuchet MS, 8pt" />
                        <MajorGrid LineColor="64, 64, 64, 64" />
                    </AxisX>
                </asp:ChartArea>
