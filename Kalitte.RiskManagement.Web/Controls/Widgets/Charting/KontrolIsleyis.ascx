<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KontrolIsleyis.ascx.cs" Inherits="Kalitte.RiskManagement.Web.Controls.Widgets.Charting.KontrolIsleyis" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <asp:Label ID="ctlDesc" runat="server" CssClass="widget-description"></asp:Label>
        <asp:Chart ID="chr" runat="server">
            <Titles>
                <asp:Title Name="chartTitle" DockedToChartArea="ChartArea1" IsDockedInsideChartArea="false" ForeColor="26, 59, 105"  Font="Trebuchet MS, 11.25pt, style=Bold"
                    ShadowOffset="0" />
            </Titles>
            <Legends>
