<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LoginWindowControl.ascx.cs"
    Inherits="Kalitte.RiskManagement.Web.Controls.Site.LoginWindowControl" %>
    ...
    <Buttons>
        <ext:Button ID="loginOK" runat="server" Text="OK" Icon="Accept">
            ...
            <DirectEvents>
                ...
                <EventMask ShowMask="true" CustomTarget="#{LoginWindow}" Target="CustomTarget" Msg="Giriş yapılıyor ..." />
                </Click>
            </DirectEvents>
        </ext:Button>
    </Buttons>
